...
jsPsych.plugins["image-button-response"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      prompt_location: {
        ...
        options: ['above','below'],
        default: 'above',
        description: 'Indicates whether to show prompt "above" or "below" the iamges.'
      },
      stimulus_duration: {
        type: jsPsych.plugins.parameterType.INT,
  ...
  plugin.trial = function(display_element, trial) {
    //display stimulus 
    var html = '<img src="'+trial.stimuli+'" id="jspsych-image-button-response-stimuli" style= 100px"';
